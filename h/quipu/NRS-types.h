...
#define	free_NRS_Context(parm)\
	 fre_obj((char *) parm, _ZNRS_mod.md_dtab[_ZContextNRS], &_ZNRS_mod, 1)
...
#define	free_NRS_Address__space__id(parm)\
	 fre_obj((char *) parm, _ZNRS_mod.md_dtab[_ZAddress_space_idNRS], &_ZNRS_mod, 1)
...
#define	free_NRS_Addressing__info(parm)\
	 fre_obj((char *) parm, _ZNRS_mod.md_dtab[_ZAddressing_infoNRS], &_ZNRS_mod, 1)
...
#define	free_NRS_NRSInformation(parm)\
	 fre_obj((char *) parm, _ZNRS_mod.md_dtab[_ZNRSInformationNRS], &_ZNRS_mod, 1)
#endif
